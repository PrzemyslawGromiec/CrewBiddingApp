...
class FlightTemplate {
    ...
    public FlightTemplate(String flightNumber, String airportCode, LocalTime reportTime, LocalTime clearTime,
                          int durationDays, List<DayOfWeek> days, AircraftType aircraftType) {
